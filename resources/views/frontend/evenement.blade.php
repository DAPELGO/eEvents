    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-10 mission pb-2">
                <div class="row">
                    <div class="col-lg-4">
                        <img src="{{ asset('images/events/'.$evenement->url_img) }}" style="height: 30rem;" alt="evenement IMG">
                    </div>
                    <div class="col-lg-10">
                        <h2 class="title" style="text-align: center;">{{ $evenement->libelle }}</h2>
                    </div>
                </div>

                <hr>
                <h4><a href="#">{{ $evenement->libelle }}</a></h4>
