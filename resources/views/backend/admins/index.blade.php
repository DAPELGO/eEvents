                        ...
                        <div class="card-header">
                            <div class="row m-b-10">
                                <div class="col-6">
                                    ...
                                    <h6 class="card-subtitle">Liste des Utilisateurs </h6>
                                </div>
                            </div>
                        </div>
                        ...
                        <table id="dt" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="{{ route('categories.edit', $user->id) }}" class="btn btn-sm btn-warning" title="Modifier la Utilisateur">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <a href="{{ route('categories.delete', $user->id) }}" class="btn btn-sm btn-delete btn-danger sweet-conf" data="Voulez vous supprimer cette Utilisateur ?" title="Supprimer la Utilisateur">
