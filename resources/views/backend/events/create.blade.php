                        ...
                        <div class="col-12 col-xl-10 order-1 order-xl-0">
                            <form action="{{ route('evenements.store') }}" method="POST" class="g-3 border p-4 rounded-2" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="5" maxlength="600" placeholder="Description de l'évènement..." required>{{ old('description') }}</textarea>
