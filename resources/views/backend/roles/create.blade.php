...
<div class="mt-4 shadow-lg p-4 ps-6 mb-4">
    <p class="text-700 fw-bold">Création d'un nouveau rôle</p>
    <hr>
    <div class="row g-4">
                                    ...
                                    @foreach($groupPermissions as $permission)
                                        <div class="col-lg-4">
                                            <div class="form-check">
                                                <input class="form-check-input" id="{{ $permission->id }}" name="permission[]" type="checkbox" value="{{ $permission->id }}" @if (is_array(old('permission')) && in_array($permission->id, old('permission'))) checked @endif />
