...
class LoginController extends Controller
{
    ...
    | redirecting them to youradmin/home screen. The controller uses a trait
    ...
    */
    ...
    {
        return view('backend.recover-password');
    }
    ...
    protected function sendFailedLoginResponse(Request $request)
    {
        ...
        if ($fields['email'] == 'inactif') {
            ...
            $errors = [$this->username()=>trans('Identifiant/mot de passe incorrect')];
        }
